...
const freeFilesTourJoyRideSteps = [
  {
    ...
    content: '10 فایل رایگان:یکی از تفاوت های اصلی ما با سایر پلتفرم های آگهی دهنده معرفی مالکین بدون حضور واسطه هاست که در نهایت بدون پرداخت کمیسیون معاملتون انجام میشه.در جهت اثبات این موضوع پس از اولین ثبت نام،چنانچه مایل باشید درخواست 10 عدد فایل رایگان را کلیک کنید،و با انتخاب حداکثر 10 فایل رایگان و 10 فایل جایگزین،درخواست شما بلا فاصله به اپراتور منتقل و سپس اپراتور به لحظه،با مالک تماس گرفته و موجودیت فایل احراز میگردد،و پس از آن برای شما ارسال میگردد.در ادامه چنانچه مایل بودید میتوانید از خرید فایل های استعلامی یا اشتراک ماهانه بهره مند شوید.همراهتان هستیم تا انتقال قراردادتان در سامانه رسمی(ثبت قرارداد برای شما رایگان میباشد)'
  },
  {
    target: '.search-button',
    content: 'تک فایل استعلامی:پس از دریافت 10 فایل رایگان خود میتوانید با انتخاب موارد درخواستی به همراه جایگزین توسط اپراتور ما استعلام موجودیت به لحظه انجام شده و سپس برایتان ارسال میگردد.یکی از ارزش های فایل موجودیت به لحظه میباشد،و باز این تفاوت ماست با سایر پلتفرم ها،همراهتان هستیم تا پایان قرارداد رسمی.'
  },
];
    ...
    <div className="flex flex-column justify-content-center body" style={{backgroundColor: '#fcfcff'}}>
      ...
      <Dialog header={<h2>ثبت قرارداد</h2>}
        ...
        <div className={styles.dialog_wrapper}>
          <p>
            کاربرگرامی،از آنجایی که عده زیادی از کاربران آشنایی با نحوه ثبت قرارداد در سامانه رسمی(مصوب قانون
            1404/04/03)را ندارند و ممکن است به این موضوع فکر کنند که فرضا از طریق این پلتفرم ملک دلخواه خود را پیدا
            کرده،و حال چه کنم؟تیم بی واسط بر آن شد،کاربران این پلتفرم را آسوده خاطر سازد و به صورت رایگان جهت رفاه حال
            شما عزیزان (کاربران پلتفرم بی واسط) نسبت به ثبت قرارداد (صرفا فایل های پلتفرم)اقدام نماید.لازم به ذکر است
            کاربرانی که ملک دلخواه خود را خارج از پلتفرم انتخاب کرده باشند این خدمت مشمول هزینه یک میلیون تومانی می
            باشد.
          </p>
