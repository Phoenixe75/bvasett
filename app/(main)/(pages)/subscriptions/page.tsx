...
const initialData: SubscriptionPlanItem = {
  active: true,
  created: '',
  description: ['قابل استفاده برای کاربران جدید', 'قابلیت مشاهده 10 فایل انتخابی به صورت رایگان', 'فعال بر روی تمامی معاملات خرید و فروش / رهن / اجاره'],
  duration_days: 0,
  id: 0,
  name: 'معمولی',
  ordering: 0,
  ...
  return (
    <LoadingPage isLoading={isLoading}>
      ...
      <div style={{minHeight: '80dvh'}}
           className={classNames(styles.wrapper, "flex justify-content-center aling-items-center")}>
        <InfoDetail/>
