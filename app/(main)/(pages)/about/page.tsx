                ...
                >
                    <div className="p-d-flex p-dir-column p-ai-center p-jc-center p-mt-5">
                        ...
                        <main className="p-p-3 p-max-w-800 p-shadow-2 p-border-round">
                            ...
                            <h2 className="h4 p-text-lg p-mb-3 text-bold">
                                ما در بی‌واسط،ارتباط مستقیم خریدار و فروشنده را ممکن کرده‌ایم
                            </h2>
                            <p className="h5" style={{ color: 'red' }}> حذف کمیسیون, ارتباط مستقیم بین خریدار,مستاجر و مالک,قیمت واقعی</p>
                            <p>
