    ...
    <div className="card p-fluid">
      ...
      {/*<Panel header="در خصوص مالکین" className="text-lg red m-2">
            ...
            <Panel header="در خصوص مصرف کنندگان" className="text-lg red m-2">
                <p className="m-2">
                    (
                  <span className="text-blue-300">در جهت راستی آزمایی عملکرد این بستر ، اولین سفارش شما تا سقف 10 فایل رایگان بوده تا عملکرد ما اثبات گردد،پس از آن در صورت تمایل میتوانید نسبت به خرید تک فایل یا اشتراک ماهانه به همراه تخفیفات (بیشتر از 3 عدد 30% تخفیف،بیشتر از 7 عدد 50% تخفیف)</span>
