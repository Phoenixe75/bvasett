  ...
  const freeFilesSteps = [
    {
      ...
      content: (
        <p>یکی از تفاوت های اصلی ما با سایر پلتفرم های آگهی دهنده معرفی مالکین بدون حضور واسطه هاست که در نهایت بدون
          پرداخت کمیسیون معاملتون انجام میشه.در جهت اثبات این موضوع پس از اولین ثبت نام،چنانچه مایل باشید درخواست ۳ عدد
          فایل رایگان را کلیک کنید،و با انتخاب حداکثر ۳ فایل رایگان و ۳ فایل جایگزین،درخواست شما بلا فاصله به اپراتور
