...
import { getAdsDetails, getCitiesByState, getDistricts, getNeighborhoodsByDistrict, getStates, updateAds } from '../../(services)/ads.service';
import { DirectionEnum, IAdsBase, ICity, IDirection, IDistricts, INeighborhoods, IState } from '../../(models)/ads';
import { InputNumber } from 'primereact/inputnumber';
import { activeOption, ageOption, directionsOption, locationOption, purposeOption, TypeOption } from '../../constant/converter';
    ...
    return (
        <div className="card detailsData">
            ...
            <form onSubmit={submitForm} className="grid p-fluid mt-6">
                ...
                <div className="field col-12 md:col-4">
                    <span className="p-float-label">
                        <MultiSelect name="directions" id="directions" value={directionsState} onChange={handleDirectionsChange} options={directionsOption} optionLabel="name" placeholder="انتخاب کنید" required />{' '}
                        <label htmlFor="directions">جهت ملک</label>
                    </span>
                </div>
                <div className="field col-12 md:col-4">
                    <span className="p-float-label">
                        <InputText type="text" autoComplete="off" value={formData.slug} onChange={(e) => handleSelect('slug', e.target.value)} />
                        <label htmlFor="slug">کد یکتا</label>
                    </span>
                </div>
                <div className="field col-12 md:col-4">
                    <span className="p-float-label">
                        <InputText type="text" id="area" autoComplete="off" value={formData.area} onChange={(e) => setValue('area', e.target.value)} required />
                        <label htmlFor="area">
                ...
                <div className={`field col-12 md:col-4 ${formData.type === 4 ? `hidden` : `block`}`}>
                    <span className="p-float-label">
                        <InputNumber type="text" id="floors" value={formData.floors} onChange={(e) => setValue('floors', e.value)} />
                ...
                <div className={`field col-12 md:col-4 ${formData.type === 4 ? `hidden` : `block`}`}>
                    <span className="p-float-label">
                        <InputNumber type="text" id="units_per_floor" value={formData.units_per_floor} onChange={(e) => setValue('units_per_floor', e.value)} />
                ...
                <div className={`field col-12 md:col-4 ${formData.type === 4 ? `hidden` : `block`}`}>
                    <span className="p-float-label">
                        <InputNumber type="text" id="rooms" value={formData.rooms} onChange={(e) => setValue('rooms', e.value)} />
                        <label htmlFor="rooms">
                ...
                <div className={`field col-12 md:col-4 ${formData.type === 4 ? `hidden` : `block`}`}>
                    <span className="p-float-label">
                        <InputNumber type="text" id="warehouses" value={formData.warehouses} onChange={(e) => setValue('warehouses', e.value)} />
                ...
                <div className={`field col-12 md:col-4 ${formData.type === 4 ? `hidden` : `block`}`}>
                    <span className="p-float-label">
                        <InputNumber type="text" id="parking" value={formData.parking} onChange={(e) => setValue('parking', e.value)} />
                ...
                <div className={`field col-12 md:col-4 ${formData.type === 4 ? `hidden` : `block`}`}>
                    <span className="p-float-label">
                        <InputNumber type="text" id="elevators" value={formData.elevators} onChange={(e) => setValue('elevators', e.value)} />
                ...
                <div className={`field col-12 md:col-4 ${formData.type === 4 ? `hidden` : `block`}`}>
                    <span className="p-float-label">
                        <InputNumber type="text" id="squat_toilets" value={formData.squat_toilets} onChange={(e) => setValue('squat_toilets', e.value)} />
                ...
                <div className={`field col-12 md:col-4 ${formData.type === 4 ? `hidden` : `block`}`}>
                    <span className="p-float-label">
                        <InputNumber type="text" id="sitting_toilets" value={formData.sitting_toilets} onChange={(e) => setValue('sitting_toilets', e.value)} />
                ...
                <div className="field col-12 md:col-4">
                    <span className="p-float-label">
                        <InputText type="text" id="address" value={formData.address} onChange={(e) => setValue('address', e.target.value)} required />
                ...
                <div className="field col-12 md:col-4">
                    <span className="p-float-label">
                        <InputText type="text" id="owner_name" autoComplete="off" value={formData.owner_name} onChange={(e) => handleSelect('owner_name', e.target.value)} required />
                        <label htmlFor="owner_name">نام مالک</label>
                    </span>
                </div>
                <div className="field col-12 md:col-4">
                    <span className="p-float-label">
                        <InputText type="text" id="owner_phone" autoComplete="off" value={formData.owner_phone} onChange={(e) => handleSelect('owner_phone', e.target.value)} required />
                        <label htmlFor="owner_phone">شماره تماس</label>
                    </span>
                </div>
                <div className="field col-12 md:col-4">
                    <span className="p-float-label">
                        <InputText type="text" id="owner_phone2" autoComplete="off" value={formData.owner_phone2 || ''} onChange={(e) => handleSelect('owner_phone2', e.target.value)} />
                ...
                <div className="field col-12 md:col-4">
                    <span className="p-float-label">
                        <InputText type="text" autoComplete="off" value={formData.description || ''} onChange={(e) => handleSelect('description', e.target.value)} />
