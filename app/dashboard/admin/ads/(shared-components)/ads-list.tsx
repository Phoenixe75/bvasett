  ...
  const getItems = (rowData: IAdsBase): MenuItem[] => [
    {
      ...
      command: () => {
        router.push(`ads/details/${rowData.id}`)
      }
    },
    {
      label: 'ویرایش',
  ...
  return (
    <>
      ...
      <div className="card">
        ...
        <DataTable key={loading ? 'true' : 'false'} value={ads} paginator={false} rows={rows}
                   tableStyle={{minWidth: '50rem'}} className="p-datatable-gridlines" emptyMessage="آگهی یافت نشد">
