  ...
  return (
    <div className="card detailsData">
        ...
        <div className="grid p-fluid mt-6">
          ...
          <div className="field col-12 md:col-4">
                      <span className="p-float-label">
                          <InputText type="text" name="registered_date"
                                     dir="ltr"
                                     value={ads?.registered_date || ''} readOnly/>
          ...
          <div className="field col-12 md:col-4">
                      <span className="p-float-label">
                          <InputText type="text" name="checked_at"
                                     dir="ltr"
                                     value={convertDateTimeToString(ads?.checked_at || '')} readOnly/>
          ...
          <div className="field col-12 md:col-4">
                      <span className="p-float-label">
                          <InputText type="text" name="directions"
                                     value={ads?.directions ? ads.directions.join(' - ') : ''} readOnly/>
          ...
          <div className={`field col-12 md:col-4 ${ads?.type === 4 ? `hidden` : `block`}`}>
                      <span className="p-float-label">
                          <InputText type="text" name="floor" value={ads?.floor || ''} readOnly/>
          ...
          <div className={`field col-12 md:col-4 ${ads?.purpose === 1 || ads?.purpose === 5 ? `hidden` : `block`}`}>
                      <span className="p-float-label">
                          <InputText type="text" name="rent_pre_paid_amount"
                                     value={formatNumber(ads?.rent_pre_paid_amount) + ' تومان '} readOnly/>
                          <label htmlFor="rent_pre_paid_amount">ودیعه اجاره</label>
                      </span>
          </div>
          <div
            className={`field col-12 md:col-4 ${ads?.purpose === 1 || ads?.purpose === 4 || ads?.purpose === 5 ? `hidden` : `block`}`}>
                      <span className="p-float-label">
                          <InputText type="text" name="rent_price" value={formatNumber(ads?.rent_price) + ' تومان '}
                                     readOnly/>
                          <label htmlFor="rent_price">مبلغ اجاره</label>
                      </span>
          </div>
          <div
            className={`field col-12 md:col-4 ${ads?.purpose === 2 || ads?.purpose === 3 || ads?.purpose === 4 ? `hidden` : `block`}`}>
                      <span className="p-float-label">
                          <InputText type="text" name="unit_price" value={formatNumber(ads?.unit_price) + ' تومان '}
                                     readOnly/>
          ...
          <div
            className={`field col-12 md:col-4 ${ads?.purpose === 2 || ads?.purpose === 3 || ads?.purpose === 4 ? `hidden` : `block`}`}>
                      <span className="p-float-label">
                          <InputText type="text" name="total_price" value={formatNumber(ads?.total_price) + ' تومان '}
                                     readOnly/>
          ...
          <div className="field col-12 md:col-4">
                      <span className="p-float-label">
                          <Dropdown type="text" name="city" id="city"
                                    value={cities.find((option) => option.id === ads?.city) || null} options={cities}
                                    optionLabel="name" placeholder="انتخاب کنید" className="w-full" readOnly/>
