...
export interface IAdsBase {
  ...
  rent_pre_paid_amount_rounded: string;
  rent_price: string;
  rent_price_rounded: string;
  unit_price: string;
  unit_price_rounded: string;
  total_price: string;
  total_price_rounded: string;
  type: number | null;
  sold: boolean;
  state: number | null;
  city: number | null;
...
export interface IBuyAds extends IAds {
  ...
  unit_price_rounded?: string; // required
}
...
export interface IRentAds extends IAds {
  ...
  rent_pre_paid_amount_rounded?: string; // required
