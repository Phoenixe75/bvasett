  ...
  return (
    <div className="card p-fluid">
      ...
      <div className="card">
        ...
        <DataTable key={loading ? "true" : 'false'} value={users} paginator={false} rows={rows}
                   tableStyle={{minWidth: '50rem'}} className="p-datatable-gridlines" emptyMessage="کاربری یافت نشد">
        ...
        <Paginator dir="ltr" first={page * rows}
                   rows={rows}
                   totalRecords={count}
