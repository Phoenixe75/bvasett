...
const OrderList: React.FC<IOrdersProps> = ({ data, loading, totalCount, currentPage, onPageChange, refreshData }) => {
        ...
        <div className="grid detailsData ">
            <div className="col-12">
                <div className="card p-fluid">
                    ...
                    <DataTable  value={data} stripedRows paginator rows={10} totalRecords={totalCount} first={(currentPage - 1) * 10} onPage={handlePageChange} tableStyle={{ minWidth: '50rem' }} emptyMessage="سفارشی موجود نیست">
                        ...
                        <Column field="order_status" header="وضعیت سفارش" body={(rowData) => OrderStatusConverter(rowData.order_status)}></Column>
                        <Column field="payment_status" header="وضعیت پرداخت" body={(rowData) => PaymentStatusConverter(rowData.payment_status)}></Column>
