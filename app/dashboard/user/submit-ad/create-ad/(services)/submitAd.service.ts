...
export const createAd = async (formData: Record<any,any>): Promise<SubmitAdFormData> => {
    try {
        const response = await axios.post<SubmitAdFormData>(`${baseUrl}/api/properties/`, formData, {
            headers: {
