...
const NewAds = () => {
  ...
  const [formData, setFormData] = useState<IAdsBase>({
    ...
    rent_pre_paid_amount_humanized: '',
    rent_price: '',
    rent_price_humanized: '',
    unit_price: '',
    unit_price_humanized: '',
    total_price: '',
    total_price_humanized: '',
    sold: false,
    type: 0,
    state: 0,
    city: 0
      ...
      <form onSubmit={submitForm} className="grid p-fluid mt-6">
        <div className="field col-12 md:col-4">
                    <span className="p-float-label">
                        <InputText type="text" ref={inputRef} name="title" id="title" autoComplete="off"
                                   value={formData.title} onChange={(e) => setValue('title', e.target.value)} required/>
        ...
        <div className="field col-12 md:col-4">
                    <span className="p-float-label">
                        <InputText type="text" name="slug" id="slug" autoComplete="off" value={formData.slug}
        ...
        <div className="field col-12 md:col-4">
                    <span className="p-float-label">
                        <InputText type="text" name="area" id="area" autoComplete="off" value={formData.area}
        ...
        <div className={`field col-12 md:col-4 ${formData.type === 4 ? `hidden` : `block`}`}>
                    <span className="p-float-label">
                        <InputNumber type="text" id="floors" value={formData.floors}
                                     onChange={(e) => setValue('floors', e.value)} disabled={formData.type === 4}
        ...
        <div className={`field col-12 md:col-4 ${formData.type === 4 ? `hidden` : `block`}`}>
                    <span className="p-float-label">
                        <InputNumber type="text" id="units_per_floor" value={formData.units_per_floor}
                                     ...
                                     disabled={formData.type == 4} required={formData.type !== 4}/>
        ...
        <div className={`field col-12 md:col-4 ${formData.type === 4 ? `hidden` : `block`}`}>
                    <span className="p-float-label">
                        <InputNumber type="text" id="rooms" value={formData.rooms}
                                     onChange={(e) => setValue('rooms', e.value)} disabled={formData.type == 4}
                                     required={formData.type !== 4}/>
                        <label htmlFor="rooms">
        ...
        <div className={`field col-12 md:col-4 ${formData.type === 4 ? `hidden` : `block`}`}>
                    <span className="p-float-label">
                        <InputNumber type="text" id="warehouses" value={formData.warehouses}
                                     onChange={(e) => setValue('warehouses', e.value)} disabled={formData.type == 4}
                                     required={formData.type !== 4}/>
        ...
        <div className={`field col-12 md:col-4 ${formData.type === 4 ? `hidden` : `block`}`}>
                    <span className="p-float-label">
                        <InputNumber type="text" id="parking" value={formData.parking}
                                     onChange={(e) => setValue('parking', e.value)} disabled={formData.type == 4}
                                     required={formData.type !== 4}/>
        ...
        <div className={`field col-12 md:col-4 ${formData.type === 4 ? `hidden` : `block`}`}>
                    <span className="p-float-label">
                        <InputNumber type="text" id="elevators" value={formData.elevators}
                                     onChange={(e) => setValue('elevators', e.value)} disabled={formData.type == 4}
                                     required={formData.type !== 4}/>
        ...
        <div className={`field col-12 md:col-4 ${formData.type === 4 ? `hidden` : `block`}`}>
                    <span className="p-float-label">
                        <InputNumber type="text" id="squat_toilets" value={formData.squat_toilets}
                                     onChange={(e) => setValue('squat_toilets', e.value)} disabled={formData.type == 4}
                                     required={formData.type !== 4}/>
        ...
        <div className="field col-12 md:col-4">
                    <span className="p-float-label">
                        <InputText type="text" autoComplete="off" id="address" value={formData.address}
        ...
        <div className="field col-12 md:col-4">
                    <span className="p-float-label">
                        <InputText type="text" name="owner_name" id="owner_name" autoComplete="off"
                                   value={formData.owner_name} onChange={(e) => setValue('owner_name', e.target.value)}
                                   required/>
        ...
        <div className="field col-12 md:col-4">
                    <span className="p-float-label">
                        <InputText type="text" name="owner_phone" id="owner_phone" autoComplete="off"
                                   ...
                                   onChange={(e) => setValue('owner_phone', e.target.value)} required/>
        ...
        <div className="field col-12 md:col-4">
                    <span className="p-float-label">
                        <InputText type="text" name="owner_phone2" id="owner_phone2" autoComplete="off"
                                   ...
                                   onChange={(e) => setValue('owner_phone2', e.target.value)}/>
          ...
          className={`field col-12 md:col-4 ${formData.purpose === 1 || formData.purpose === 5 ? `hidden` : `block`}`}>
                    <span className="p-float-label">
                        <InputText type="text" autoComplete="off" id="rent_pre_paid_amount"
                                   ...
                                   onChange={(e) => setValue('rent_pre_paid_amount', parseNumber(e.target.value))}/>
          ...
          className={`field col-12 md:col-4 ${formData.purpose === 1 || formData.purpose === 4 || formData.purpose === 5 ? `hidden` : `block`}`}>
                    <span className="p-float-label">
                        <InputText type="text" autoComplete="off" id="rent_price"
                                   ...
                                   onChange={(e) => setValue('rent_price', parseNumber(e.target.value))}/>
          ...
          className={`field col-12 md:col-4 ${formData.purpose === 2 || formData.purpose === 3 || formData.purpose === 4 ? `hidden` : `block`}`}>
                    <span className="p-float-label">
                        <InputText type="text" autoComplete="off" id="unit_price"
                                   ...
                                   onChange={(e) => setValue('unit_price', parseNumber(e.target.value))}/>
        ...
        <div className="col-12">
          <div className="field flex col-12 md:col-2 ">
            <Button onClick={(e) => submitForm(e)} raised type="submit" label="ثبت"
                    className="bg-green-500 text-white border-0 mt-2 ml-2" disabled={loading.current}
