    ...
    const adminItems =
      user?.is_staff && user?.is_admin
        ? [
          ...
          {
            label: 'مدیریت نواقص', icon: 'pi pi-fw pi-file ml-2', to: '/dashboard/admin/defect-management/list',
            items: [
              {
                label: DeflectManagementTranslations.incomplete, icon: 'pi pi-fw pi-search ml-2',
                to: AdCompleteStatusEnum.incomplete
              },
              {
                label: DeflectManagementTranslations.rejected, icon: 'pi pi-fw pi-search ml-2',
                to: AdCompleteStatusEnum.rejected
              },
              {
                label: DeflectManagementTranslations.complete, icon: 'pi pi-fw pi-search ml-2',
                to: AdCompleteStatusEnum.complete
              }
            ]
          },
        ...
        : user?.is_staff
          ? [
            ...
            {label: 'ارسال پیامک', icon: 'pi pi-fw pi-send ml-2', to: '/dashboard/admin/send-sms'},
            {
              label: 'مدیریت نواقص', icon: 'pi pi-fw pi-file ml-2',
              items: [
                {
                  label: DeflectManagementTranslations.incomplete, icon: 'pi pi-fw pi-search ml-2 mr-2',
                  to: `/dashboard/admin/defect-management/list/${AdCompleteStatusEnum.incomplete}`
                },
                {
                  label: DeflectManagementTranslations.rejected, icon: 'pi pi-fw pi-search ml-2 mr-2',
                  to: `/dashboard/admin/defect-management/list/${AdCompleteStatusEnum.rejected}`
                },
                {
                  label: DeflectManagementTranslations.complete, icon: 'pi pi-fw pi-search ml-2 mr-2',
                  to: `/dashboard/admin/defect-management/list/${AdCompleteStatusEnum.complete}`
                }
              ]
            },
            {label: 'مدیریت آگهی‌ها', icon: 'pi pi-fw pi-box ml-2', to: '/dashboard/admin/ads'},
